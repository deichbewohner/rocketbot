...
- `BOTn_RENDER_MODE=detailed|concise` (default: `detailed`)
...
In `concise` mode, structured tool progress is collapsed into a single line such as
`1 skill, 2 reads, 3 tools` above the assistant text.
